...
export function CalendarIcon(props: BasicIconProps) {
  return <SvgIcon {...props}><path fillRule="evenodd" clipRule="evenodd" d="M5 1a.75.75 0 0 1 .75.75V2.5h4.5V1.75a.75.75 0 0 1 1.5 0V2.5h.25A2.5 2.5 0 0 1 14.5 5v7a2.5 2.5 0 0 1-2.5 2.5H4A2.5 2.5 0 0 1 1.5 12V5A2.5 2.5 0 0 1 4 2.5h.25V1.75A.75.75 0 0 1 5 1ZM3 6.5v5.5c0 .552.448 1 1 1h8c.552 0 1-.448 1-1V6.5H3Z" /></SvgIcon>;
}
